...
/**
 * 5.9 设置混音时麦克风音量大小，仅在播放背景音乐混音时使用。
 *
 * @param volume 音量大小，1为正常音量，范围是0 - 1之间的浮点数。
 * @return YES：成功；NO：失败。
 */
 ...
 * 9.1 设置美颜级别和美白级别
 *
 * @deprecated v6.9 版本弃用，请使用 TXBeautyManager 设置滤镜
 */
...
/**
 * 9.6 设置 V 脸级别（企业版有效，其它版本设置此参数无效）
 *
 * @deprecated v6.9 版本弃用，请使用 TXBeautyManager 设置美颜功能
 */
...
/**
 * 9.7 设置下巴拉伸或收缩（企业版有效，其它版本设置此参数无效）
 *
 * @deprecated v6.9 版本弃用，请使用 TXBeautyManager 设置美颜功能
 */
...
/**
 * 9.10 设置绿幕背景视频（企业版有效，其它版本设置此参数无效）
 *
...
/**
 * 9.11 选择使用哪一款 AI 动效挂件（企业版有效，其它版本设置此参数无效）
 *
 * @deprecated v6.9 版本弃用，请使用 TXBeautyManager 设置美颜功能
 */
